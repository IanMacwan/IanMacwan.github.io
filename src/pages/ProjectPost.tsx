...
export default function ProjectPost() {
  ...
  const post: Post | undefined = projectPosts.find((p) => p.slug === slug);
  ...
  if (!post) {
    return (
      <div className="nvim-overlay nvim-visible" style={{ alignItems: "center", justifyContent: "center", display: "flex", flexDirection: "column", gap: "1rem" }}>
        <div style={{ color: "var(--red)", fontSize: "1.1rem" }}>E:404 — project not found: {slug}.md</div>
        <Link to="/projects" style={{ color: "var(--blue)" }}>← back to projects index</Link>
      </div>
    );
  }
    ...
    <div className={`nvim-overlay ${visible ? "nvim-visible" : ""}`}>
      ...
      <div className="nvim-body">
        ...
        <div className="nvim-info-panel">
          <div className="info-panel-header">PROJ INFO</div>
